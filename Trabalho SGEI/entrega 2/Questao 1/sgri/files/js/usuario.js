...
$(document).ready(function(){
    $("#salvar-form").click(function(){
        ...
        $.ajax({
            ...
            data: "codigo="+codigo+"&nome="+nome+"&senha="+senha+"&confirmacao="+confirmacao+"&tipo="+tipo+"&status="+status,
    ...
    $("#buscar").click(function(){
        var tipo = $("#tipo").val();
        var nome = $("#nome").val();
        window.location = "http://localhost/sgri/usuario/grid?nome="+nome+"&tipo="+tipo;
    });
