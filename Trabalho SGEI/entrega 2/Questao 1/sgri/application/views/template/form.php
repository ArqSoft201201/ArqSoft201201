<html>
    ...
    <body>
        ...
        <div id="campos">
            <ul>
                <li class="abas" id="abre-grid"><a href="#">Grid</a></li>
            ...
            <form>
                ...
                <div id='botoes'>
                    ...
                    <input type="button" value="Voltar" id="voltar" alt="Voltar" title="Voltar">
					<input type="button" value="Excluir" id="excluir-form" alt="Excluir" title="Excluir">
					<input type="button" value="Salvar" id="salvar-form" alt="Salvar" title="Salvar">
					<input type="button" value="Novo" id="novo" title="Novo" alt="Novo">
